...
ok: [10.255.1.12] => {
    "msg": [
        [
            ...
            "LAST DEPLOYED: Wed Aug  7 16:44:09 2024",
            ...
            "  - https://kubernetes-dashboard.idc-ingress-nginx.bghdkj.com",
            "  - https://k8s-dash.idc-ingress-nginx.bghdkj.com"
        ],
        [
            "Error from server (AlreadyExists): namespaces \"kube-system\" already exists"
        ]
    ]
}
```
